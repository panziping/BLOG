...
![](picture/Intel FPGA (7)：adc adc128s102-p1.png)

### ADC128S102

这里截取了AC128S102的部分数据手册，读者自行阅读。

![](picture/Intel FPGA (7)：adc adc128s102-p2.png)

![image-20240324163456342](picture/Intel FPGA (7)：adc adc128s102-p3.png)

![](picture/Intel FPGA (7)：adc adc128s102-p4.png)

![](picture/Intel FPGA (7)：adc adc128s102-p5.png)

![](picture/Intel FPGA (7)：adc adc128s102-p6.png)
