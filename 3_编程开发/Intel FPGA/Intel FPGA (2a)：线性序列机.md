...
这一部分展示线性序列机应用在数码管驱动电路中（完整请见[Intel FPGA (2b)：数码管显示(LSM)]()），需要通过线性序列机产生三个信号**seg_sclk（sh_cp）,seg_rclk（st_cp）,seg_dio(ds)**。

波形图

![](Intel FPGA (2a)：线性序列机-P4.png)
